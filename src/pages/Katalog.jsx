    ...
    <div className="font-body antialiased">
      ...
      {/* <nav className="bg-[#F5F5DC]/80 dark:bg-stone-900/80 backdrop-blur-md text-[#004E50] dark:text-[#00686B] docked full-width top-0 sticky z-50 no-border bg-gradient-to-b from-[#F5F5DC] to-transparent shadow-sm shadow-[#004E50]/5 glass-nav">
        <div className="flex justify-between items-center px-8 py-4 max-w-full mx-auto">
          <div className="text-2xl font-serif font-bold text-[#004E50] dark:text-[#00686B] tracking-tighter">
            SenyumStudioFoto
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 w-full max-w-7xl mx-auto">
            <div className="md:col-span-7 flex flex-col justify-center z-10">
              ...
              <div className="flex gap-6">
                <button className="bg-primary text-on-primary px-10 py-4 rounded-lg font-medium editorial-shadow hover:scale-105 transition-transform">
                  Jelajahi Paket
                </button>
              </div>
            </div>
